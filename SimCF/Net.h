...
const char CLIENT_ID[] = "EASyCFc1";   // client ID
const char SERVER_ID[] = "EASyCFs1";   // server ID
...
int __fastcall netSendData(char *data, int &size, char *remoteIP); // sends network data
int __fastcall netReadData(char *data, int &size, char *senderIP); // returns network data
